...
export default function BreakingTicker({ items = DEFAULT_ITEMS }: Props) {
  ...
  return (
    <div className="w-full bg-secondary-container text-on-secondary-container h-10 flex items-center overflow-hidden z-[60] relative border-b border-secondary-fixed-dim/20">
