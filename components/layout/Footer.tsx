  ...
  return (
    <footer className="bg-surface-container-highest border-t border-white/10 w-full py-section-gap px-container-margin">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#229ED9] text-white px-6 py-2 rounded-full font-bold text-sm hover:opacity-90 transition-opacity w-fit"
            >
            ...
            <a
              href="https://x.com/palsiran_news"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white/10 text-white px-6 py-2 rounded-full font-bold text-sm hover:bg-white/20 transition-colors w-fit"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4 shrink-0" fill="currentColor">
      ...
      <div className="text-center mt-8 pt-6 border-t border-white/5">
        <p className="text-outline text-xs">© ۱۴۰۴ پالس ایران — تمامی حقوق محفوظ است | <a href="mailto:info@palsiran.com" className="hover:text-on-surface-variant transition-colors">info@palsiran.com</a></p>
      </div>
    </footer>
  );
}
