      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-section-gap text-right">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a
              href="https://www.youtube.com/@palsiran"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-[#FF0000]/80 text-white px-6 py-2 rounded-full font-bold text-sm hover:bg-[#FF0000] transition-colors w-fit"
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4 shrink-0" fill="currentColor">
