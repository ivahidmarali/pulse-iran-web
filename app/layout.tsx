...
const organizationJsonLd = {
  ...
  name: "پالس ایران",
  alternateName: ["Pulse Iran", "Pals Iran", "پالس"],
  description: "پالس ایران یک پلتفرم تجمیع اخبار فارسی است که اخبار ایران و جهان را از ۴۵+ منبع خبری با برچسب‌گذاری گرایش سیاسی و خلاصه‌سازی هوش مصنوعی ارائه می‌دهد.",
  url: SITE_URL,
