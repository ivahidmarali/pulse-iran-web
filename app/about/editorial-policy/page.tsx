...
const faqJsonLd = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "معیارهای انتخاب منابع خبری در پالس ایران چیست؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "منابع خبری پالس ایران بر اساس چهار معیار انتخاب می‌شوند: انتشار منظم و مستمر اخبار، شناسایی‌پذیری هویت منبع (کانال تلگرامی شناخته‌شده، خبرگزاری ثبت‌شده، یا رسانه با سابقه مشخص)، تنوع گرایش سیاسی برای حفظ تعادل، و کیفیت محتوا (منابعی که صرفاً شایعات منتشر می‌کنند در فهرست نیستند). منابع جدید به صورت دوره‌ای بررسی و اضافه می‌شوند.",
      },
    },
    {
      "@type": "Question",
      name: "گرایش سیاسی منابع خبری در پالس ایران چگونه طبقه‌بندی می‌شود؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "هر منبع بر اساس بررسی سابقه تحریریه، مواضع رسمی مدیران و صاحبان رسانه، الگوی پوشش رویدادهای کلیدی، و منبع تأمین مالی در یکی از ۱۱ دسته گرایش سیاسی طبقه‌بندی می‌شود: رسمی دولتی، اصولگرا، محافظه‌کار میانه، اصلاح‌طلب، اصلاح‌طلب میانه، مستقل، لیبرال غربی، لیبرال آمریکایی، چپ لیبرال، مخالف جمهوری اسلامی، و محافظه‌کار عربی. این طبقه‌بندی توصیفی است، نه ارزش‌گذارانه.",
      },
    },
    {
      "@type": "Question",
      name: "خلاصه‌سازی اخبار با هوش مصنوعی در پالس ایران چگونه کار می‌کند؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "خلاصه اخبار با استفاده از مدل‌های زبانی بزرگ (LLM) تولید می‌شود. متن کامل خبر از منبع اصلی استخراج شده، مدل هوش مصنوعی یک خلاصه حداقل ۱۵۰ کلمه‌ای تولید می‌کند که اطلاعات اصلی خبر را بدون افزودن تفسیر یا نظر منعکس می‌کند. لینک مستقیم به متن کامل در منبع اصلی همیشه حفظ می‌شود. خلاصه‌ها ممکن است خطا داشته باشند؛ همیشه منبع اصلی را برای اطمینان مطالعه کنید.",
      },
    },
    {
      "@type": "Question",
      name: "امتیاز اعتبار منابع در پالس ایران چه معنایی دارد؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "هر منبع یک امتیاز اعتبار از ۰ تا ۱۰۰ دریافت می‌کند که بر اساس ثبات انتشار، دقت تاریخی خبرهای تأیید‌شده، و شفافیت درباره هویت صاحبان رسانه تعیین می‌شود. این امتیاز در صفحه هر منبع قابل مشاهده است و به کاربران کمک می‌کند اخبار را در زمینه اعتبار منبع ارزیابی کنند.",
      },
    },
    {
      "@type": "Question",
      name: "«تأیید چندمنبعه» در پالس ایران به چه معناست؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "وقتی یک خبر از سه یا بیشتر منبع مستقل تأیید شود، نشانه «تأیید شده» در صفحه مقاله نمایش داده می‌شود. این سیستم به کاربران کمک می‌کند اخباری را که پشتوانه خبری بیشتری دارند از اخبار تک‌منبعی تشخیص دهند. تأیید چندمنبعه به معنای صحت قطعی خبر نیست.",
      },
    },
    {
      "@type": "Question",
      name: "چه نوع محتوایی در پالس ایران منتشر نمی‌شود؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "پالس ایران سه نوع محتوا منتشر نمی‌کند: محتوای تبلیغاتی یا اسپانسرشده بدون برچسب مشخص، اخبار صرفاً مبتنی بر شایعه بدون منبع قابل شناسایی، و محتوایی که آشکارا نفرت‌پراکنی یا تحریک به خشونت می‌کند.",
      },
    },
    {
      "@type": "Question",
      name: "در صورت وجود خطا در اخبار پالس ایران، چطور می‌توان درخواست اصلاح داد؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "اگر خبری که از طریق پالس ایران منتشر شده حاوی اطلاعات نادرست است یا نقض حریم خصوصی می‌کند، می‌توانید از طریق ایمیل info@palsiran.com با ما تماس بگیرید. درخواست‌های معتبر ظرف ۴۸ ساعت بررسی می‌شوند.",
      },
    },
    {
      "@type": "Question",
      name: "آیا پالس ایران وابستگی سیاسی یا مالی به منابع خبری دارد؟",
      acceptedAnswer: {
        "@type": "Answer",
        text: "خیر. پالس ایران هیچ‌گونه وابستگی مالی، سیاسی، یا سازمانی به هیچ‌یک از منابع خبری موجود در سیستم ندارد. منابع جدید صرفاً بر اساس معیارهای کیفی اضافه می‌شوند، نه بر اساس درخواست یا پرداخت مالی. این استقلال پایه اعتماد ما با کاربران است.",
      },
    },
  ],
};
